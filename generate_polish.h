#ifndef generate_polish_H    // To make sure you don't declare the function more than once by including the header multiple times.
#define generate_polish_H
#include <iostream>
#include<string>
